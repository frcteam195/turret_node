...
void set_shooter_vel(float distance)
{
    ...
    if (first_time)
    {
        ...
        shooter_rpm_lookup_table.insert(7.13,1935); //prev 1835
        shooter_rpm_lookup_table.insert(7.38,2000); //prev 1900
        shooter_rpm_lookup_table.insert(7.66,2020); //prev 1920
